...
class QrResultSuccessScreen extends StatefulWidget {
  const QrResultSuccessScreen({Key? key}) : super(key: key);

  @override
  _QrResultSuccessScreenState createState() => _QrResultSuccessScreenState();
}

class _QrResultSuccessScreenState extends State<QrResultSuccessScreen> {

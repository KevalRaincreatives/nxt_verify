...
class _QrScanPermissionScreenState extends State<QrScanPermissionScreen> {
  ...
  Future<SuccessModel?> fetchStatus(String codes) async {
    ...
    //     fontSize: 16.0);
    print('https://nxtverify.digitalsummation.com/public/api/verifyCode/435345?api_key=fdskdsfnd78435345dsfngfkehewr5gfk35g&code=$codes');
    try {
      Response response;

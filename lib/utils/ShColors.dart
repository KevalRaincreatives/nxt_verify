...
const sh_colorPrimary = Color(0xff5486E6);
const sh_colorPrimary2 = Color(0xff3e76e3);
const sh_text_back = Color(0xffE3F4F9);
const sh_colorPrimaryDark = Color(0xFFFFE63B);
const sh_colorAccent = Color(0xFF247847);
const sh_colorAccent2 = Color(0xFF46C1F4);
const sh_rating=Color(0xFFF2DE26);
const sh_rating_unrated=Color(0xFFB9B9B9);

const sh_my_green=Color(0xFF34C759);
const sh_my_red=Color(0xFFCD5050);


const sh_orange = Color(0xFF212121);
...
const sh_app_black = Color(0xFF333333);
const sh_app_red = Color(0xFFFF0000);
const sh_app_blue=Color(0xFF044FA1);
const sh_app_bar=Color(0xFFF2F2F2);
const sh_view_color = Color(0xFFeaeaea);
const sh_transparent = Color(0xFF00000000);

const sh_new_app_background=Color(0xFFFAF7F0);
const sh_app_txt_color=Color(0xFF333333);

const sh_btn_color=Color(0xFFFFE63B);
...
const sh_favourite_background = Color(0xFFfaf2f3);
const sh_favourite_unselected_background = Color(0xFFECECEC);
const sh_yellow = Color(0xFFFFE63B);
...
const Color lightBlue5 = Color(0xff5c3dff);
...
const Color lightgrey = Color(0xffF3F3F4);
 const Color grey = Color(0xffA1A3A6);
const Color sh_grey = Color(0xffA1A3A6);
 const Color darkgrey = Color(0xff747F8F);

 const Color iconColor = Color(0xffa8a09b);
 const Color yellowColor = Color(0xfffbba01);
...
const pro_back=Color(0xFFE7EFF2);

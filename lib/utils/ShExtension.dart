...
BoxDecoration boxDecoration5({double radius = spacing_middle, Color color = Colors.transparent, Color bgColor = sh_white, var showShadow = false}) {
  return BoxDecoration(
...
BoxDecoration boxDecoration6({double radius = spacing_middle, Color color = Colors.transparent, Color bgColor = sh_white, var showShadow = false}) {
  return BoxDecoration(
      gradient: LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
...
pw.RichText RichTextNormal(var title, {var fontSize = textSizeLargeMedium, textColor = sh_app_black, var fontFamily = 'Regular'}) {
  return pw.RichText(
      softWrap:true,
...
pw.RichText RichTextBold(var title, {var fontSize = textSizeLargeMedium, textColor = sh_app_black, var fontFamily = 'Regular'}) {
  return pw.RichText(
    // textAlign: pw.TextAlign.center,
      text: pw.TextSpan(children: [
        pw.TextSpan(
...
pw.RichText RichTextBoldCenter(var title, {var fontSize = textSizeLargeMedium, textColor = sh_app_black, var fontFamily = 'Regular'}) {
  return pw.RichText(
    textAlign: pw.TextAlign.center,
      text: pw.TextSpan(children: [
        pw.TextSpan(
...
pw.RichText RichTextBoldUnderline(var title, {var fontSize = textSizeLargeMedium, textColor = sh_app_black, var fontFamily = 'Regular'}) {
  return pw.RichText(
    // textAlign: pw.TextAlign.center,
      text: pw.TextSpan(children: [
        pw.TextSpan(
